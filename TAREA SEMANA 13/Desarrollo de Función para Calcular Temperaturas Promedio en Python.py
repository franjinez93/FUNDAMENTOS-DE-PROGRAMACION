def temperatura_promedio(temperaturas):
    ...
    for i, ciudad in enumerate(temperaturas):
        ...
        temperaturas_promedio[f"Ciudad {i + 1}"] = promedios_semanales
...
for ciudad, promedios in resultados.items():
    for i, promedio in enumerate(promedios):
        print(f"{ciudad}, Semana {i + 1}: Promedio = {promedio:.2f}")

    promedio_ciudad = sum(promedios) / len(promedios)
    print(f"{ciudad}: Promedio total = {promedio_ciudad:.2f}\n")
